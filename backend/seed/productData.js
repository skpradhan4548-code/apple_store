...
module.exports = [
  {
    ...
    bg: '#1d1d1f', textColor: '#ffffff', accentColor: '#a78bfa', tag: 'New', size: 'large',
    basePrice: 134900, category: 'iphone', stock: 25, active: true,
    colors: [
    ...
    storage: [
      { label: '128 GB', price: 134900 }, { label: '256 GB', price: 144900 },
      { label: '512 GB', price: 164900 }, { label: '1 TB', price: 184900 },
    ],
    specs: [
  ...
  },
  {
    ...
    bg: '#f5f5f7', textColor: '#1d1d1f', accentColor: '#0066cc', tag: 'New', size: 'large',
    basePrice: 79900, category: 'iphone', stock: 25, active: true,
    colors: [
      { label: 'Teal', hex: '#5b8a8b', price: 79900 }, { label: 'Pink', hex: '#e8b4b8', price: 79900 },
      { label: 'Ultramarine', hex: '#3a4d8f', price: 79900 }, { label: 'White', hex: '#f5f0e8', price: 79900 },
      { label: 'Black', hex: '#3c3c3c', price: 79900 },
    ],
    storage: [
      { label: '128 GB', price: 79900 }, { label: '256 GB', price: 89900 }, { label: '512 GB', price: 109900 },
    ],
    specs: [
  ...
  },
  {
    ...
    bg: '#1d1d1f', textColor: '#f5f5f7', accentColor: '#2997ff', tag: 'New', size: 'large',
    basePrice: 249900, category: 'mac', stock: 25, active: true,
    colors: [
      { label: 'Space Black', hex: '#2b2d2e', price: 249900 }, { label: 'Silver', hex: '#e3e4e5', price: 249900 },
    ],
    storage: [
      { label: '512 GB SSD', price: 249900 }, { label: '1 TB SSD', price: 279900 }, { label: '2 TB SSD', price: 339900 },
    ],
    specs: [
  ...
  },
  {
    ...
    bg: '#f5f5f7', textColor: '#1d1d1f', accentColor: '#0066cc', tag: 'New', size: 'normal',
    basePrice: 24900, category: 'airpods', stock: 25, active: true,
    colors: [{ label: 'White', hex: '#f5f5f5', price: 24900 }],
    storage: [],
    specs: [
      { label: 'Chip', value: 'Apple H2' }, { label: 'ANC', value: 'Active Noise Cancellation + Transparency mode' },
      { label: 'Battery', value: '6 hours ANC, 30 hours total with case' }, { label: 'Water', value: 'IP54 dust, sweat, and water resistant' },
  ...
  },
  {
    ...
    bg: '#000000', textColor: '#ffffff', accentColor: '#64d2ff', tag: 'New', size: 'normal',
    basePrice: 46900, category: 'watch', stock: 25, active: true,
    colors: [
      { label: 'Jet Black', hex: '#2a2a2a', price: 46900 }, { label: 'Rose Gold', hex: '#b76e79', price: 46900 },
      { label: 'Silver', hex: '#d4d4d4', price: 46900 },
    ],
    storage: [{ label: '42mm', price: 46900 }, { label: '46mm', price: 49900 }],
    specs: [
      { label: 'Chip', value: 'Apple S10' }, { label: 'Display', value: 'Always-On Retina LTPO OLED, largest ever' },
      { label: 'Health', value: 'Sleep Apnea detection, ECG, Blood Oxygen' }, { label: 'Battery', value: '18 hours (36 hours Low Power Mode)' },
  ...
  },
  {
    ...
    bg: '#f5f5f7', textColor: '#1d1d1f', accentColor: '#0066cc', tag: 'New', size: 'normal',
    basePrice: 59900, category: 'mac', stock: 25, active: true,
    colors: [{ label: 'Silver', hex: '#e0e0e0', price: 59900 }],
    storage: [
      { label: '256 GB SSD', price: 59900 }, { label: '512 GB SSD', price: 79900 },
      { label: '1 TB SSD', price: 99900 }, { label: '2 TB SSD', price: 139900 },
    ],
    specs: [
      { label: 'Chip', value: 'Apple M4, 10-core CPU' }, { label: 'Memory', value: 'Up to 32GB unified memory' },
      { label: 'Ports', value: '3× Thunderbolt 5, 2× USB-A, HDMI 2.1' }, { label: 'Size', value: '127mm × 127mm — smallest Mac ever' },
  ...
  },
  {
    ...
    bg: '#1d1d1f', textColor: '#f5f5f7', accentColor: '#2997ff', tag: 'New', size: 'normal',
    basePrice: 99900, category: 'ipad', stock: 25, active: true,
    colors: [
      { label: 'Space Black', hex: '#2d2d2d', price: 99900 }, { label: 'Silver', hex: '#e5e5e5', price: 99900 },
    ],
    storage: [
      { label: '256 GB', price: 99900 }, { label: '512 GB', price: 119900 },
      { label: '1 TB', price: 149900 }, { label: '2 TB', price: 179900 },
    ],
    specs: [
      { label: 'Chip', value: 'Apple M4, 10-core CPU' }, { label: 'Display', value: '11" or 13" Ultra Retina XDR (Tandem OLED)' },
      { label: 'Camera', value: '12MP Wide + 12MP Ultra Wide + LiDAR' }, { label: 'Battery', value: 'Up to 10 hours' },
  ...
  },
  {
    ...
    bg: '#f5f5f7', textColor: '#1d1d1f', accentColor: '#0066cc', tag: 'New', size: 'normal',
    basePrice: 134900, category: 'mac', stock: 25, active: true,
    colors: [
      { label: 'Blue', hex: '#5e85b0', price: 134900 }, { label: 'Green', hex: '#6b8c76', price: 134900 },
      { label: 'Pink', hex: '#d48e9b', price: 134900 }, { label: 'Silver', hex: '#d6d6d6', price: 134900 },
      { label: 'Orange', hex: '#d9814f', price: 134900 }, { label: 'Purple', hex: '#8e82b0', price: 134900 },
      { label: 'Yellow', hex: '#d4b84a', price: 134900 },
    ],
    storage: [
      { label: '256 GB SSD', price: 134900 }, { label: '512 GB SSD', price: 154900 }, { label: '1 TB SSD', price: 174900 },
    ],
    specs: [
      { label: 'Chip', value: 'Apple M4, 10-core CPU' }, { label: 'Display', value: '24" 4.5K Retina, 500 nits, P3 wide colour' },
      { label: 'Memory', value: 'Up to 32GB unified memory' }, { label: 'Camera', value: '12MP Center Stage webcam' },
