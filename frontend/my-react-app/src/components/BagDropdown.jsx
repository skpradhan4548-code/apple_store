        ...
        {items.length === 0 ? (
          ...
          <div className="bag-dropdown__empty">
            ...
            <div className="bag-dropdown__links">
              <Link to="/orders" className="bag-dropdown__sublink" onClick={onClose}>
              ...
              {!user ? (
                <Link to="/login" state={{ from: location.pathname }} className="bag-dropdown__sublink" onClick={onClose}>
                  <svg viewBox="0 0 18 18" width="16" height="16" fill="currentColor">
                ...
                <span className="bag-dropdown__signed-in-as">Signed in as <strong>{user.name}</strong></span>
              )}
            </div>
          </div>
        ) : (
          ...
          <div className="bag-dropdown__populated">
            ...
            <div className="bag-dropdown__populated-footer">
              <Link to="/orders" className="bag-dropdown__sublink" onClick={onClose}>
              ...
              {!user ? (
                ...
                <span className="bag-dropdown__signed-in-as">Signed in as {user.name.split(' ')[0]}</span>
              )}
            </div>
          </div>
        )}
